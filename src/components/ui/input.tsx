...
export function Input({ className, label, placeholder = " ", ...props }: Props) {
  return (
    <label className="group relative block">
      <input
        placeholder={placeholder}
        className={cn(
          "peer h-14 w-full rounded-2xl border border-white/55 bg-white/50 px-4 pt-6 text-sm text-slate-900 shadow-soft outline-none backdrop-blur-md transition",
